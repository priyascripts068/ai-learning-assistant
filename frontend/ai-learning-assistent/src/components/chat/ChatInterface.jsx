...
const ChatInterface = () => {
  ...
  if (initialLoading) {
    return (
      <div className="flex flex-col h-[70vh] bg-white border border-slate-200 rounded-2xl items-center justify-center">
  ...
  return (
    <div className="flex flex-col h-[70vh] bg-white border border-slate-200 rounded-2xl overflow-hidden">
      ...
      <div className="p-5 border-t border-slate-200 bg-white">
        <form onSubmit={handleSendMessage} className="flex items-center gap-3">
          <input
            ...
            className="flex-1 h-12 px-4 border-2 border-slate-200 rounded-xl text-sm"
            disabled={loading}
          />
          ...
          <button
            ...
            className="w-12 h-12 bg-emerald-500 hover:bg-emerald-600 text-white rounded-xl flex items-center justify-center disabled:opacity-50"
          >
